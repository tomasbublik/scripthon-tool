...
import cz.ctu.scripthon.compiler.syntax.expressions.properties.MethDefinition;
...
public class ComplexVariable extends CommonVariable {
    ...
    public ComplexVariable(String name, SupportedStructure type) {
        super(name, type);
        //TODO create map from corresponding definition (i.e.: ClassDefinition, ...) ?
        variableValues = new HashMap<>();
    }

    public ComplexVariable(String name, SupportedStructure type, Map<String, Object> values) {
        super(name, type);
        variableValues = values;
    }

    public ComplexVariable(String name, SupportedStructure type, Definition definition) {
        super(name, type);
