...
import cz.ctu.scripthon.tree.analyzer.statistics.StatisticsAnalysis;
import cz.ctu.scripthon.tree.analyzer.tree.AccessHelper;
import cz.ctu.scripthon.tree.matcher.CompilationUtils;
import cz.ctu.scripthon.tree.matcher.MainMatcherNew;
...
public class Performer {
    ...
    public static void perform(final ApplicationContext applicationContext, JProgressBar progressBar, JLabel notificationField) {
        ...
        StatisticsAnalysis.createTopLevelStatistics(applicationContext.getJavaSourcesFile().getPath());
        ...
        */
        ...
        try {
            if (program != null) {
                matchingResult = MainMatcherNew.compare(AccessHelper.getClassTrees(), program, progressBar, notificationField);
            } else {
